...
HOSPITALS = [
    ...
    # ------------------------------------------------------------------
    # Chittagong, Sylhet, Khulna — starter entries. These are well-known
    # real government medical college hospitals, but coordinates and
    # phone numbers are APPROXIMATE/UNVERIFIED (marked "VERIFY") — same
    # caution as the Dhaka set. Confirm before relying on these for a
    # real demo, and expand with more entries per city over time.
    # ------------------------------------------------------------------
    {
...
BLOOD_BANKS = [
    ...
    # ------------------------------------------------------------------
    # Divisional Red Crescent blood centers — Bangladesh Red Crescent
    # Society operates nationally with branches in major divisional
    # cities. Coordinates/phone are APPROXIMATE/UNVERIFIED ("VERIFY").
    # ------------------------------------------------------------------
    {
        ...
        "lon": 91.8317,
        "phone": "VERIFY",
        "note_bn": "বিভাগীয় রক্তদান কেন্দ্র।",
        "note_en": "Divisional blood donation center.",
    },
    {
        "name": "Bangladesh Red Crescent Society — Sylhet Blood Center",
        "area": "Sylhet",
        "lat": 24.8949,
        "lon": 91.8687,
        "phone": "VERIFY",
    ...
    {
        "name": "Bangladesh Red Crescent Society — Khulna Blood Center",
        "area": "Khulna",
        "lat": 22.8456,
        "lon": 89.5403,
        "phone": "VERIFY",
